...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<input type="hidden" id="woocommerce-lost-password-nonce" name="woocommerce-lost-password-nonce" value="1da77d4f63" /><input type="hidden" name="_wp_http_referer" value="/tai-khoan/lost-password/" />
</form>
</div>
	</div>
</div>
