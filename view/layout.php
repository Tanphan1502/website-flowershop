...
<head>
   ...
   <style id='flatsome-main-inline-css' type='text/css'>
      @font-face {
         ...
         font-display: block;
         src: url(wp-content/themes/flatsome/assets/css/icons/fl-icons2cd7.eot?v=3.17.0);
         src:
            url(wp-content/themes/flatsome/assets/css/icons/fl-icons.eot#iefix?v=3.17.0) format("embedded-opentype"),
            url(wp-content/themes/flatsome/assets/css/icons/fl-icons2cd7.html?v=3.17.0) format("woff2"),
            url(wp-content/themes/flatsome/assets/css/icons/fl-icons2cd7.ttf?v=3.17.0) format("truetype"),
            url(wp-content/themes/flatsome/assets/css/icons/fl-icons2cd7.woff?v=3.17.0) format("woff"),
            url(wp-content/themes/flatsome/assets/css/icons/fl-icons2cd7.svg?v=3.17.0#fl-icons) format("svg");
      }
   </style>
   ...
   <link rel='stylesheet' id='all-font-awesome-css' href='wp-content/themes/flatsome-child/assets/fontsawesome/css/all.min.css' type='text/css' media='all' />
   ...
   <link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embedd036.json?url=https%3A%2F%2Fshophoa5.muathemewp.com%2F" />
   <link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embedaa94?url=https%3A%2F%2Fshophoa5.muathemewp.com%2F&amp;format=xml" />
   <style>
      ...
      #yith-license-notice,
      .theme-browser .theme[data-slug="flatsome"] .update-message {
   ...
   <style id="custom-css" type="text/css">
      ...
      .nav-tabs>li.active>a {
         border-top-color: #f79f8e
      }

      .widget_shopping_cart_content .blockUI.blockOverlay:before {
         border-left-color: #f79f8e
      }
      ...
      button[type="submit"]:focus-visible {
         outline-color: #f79f8e !important;
      }
      ...
      .alt:focus-visible {
         outline-color: #9da4d5 !important;
      }

      .success.is-underline:hover,
      .success.is-outline:hover,
      .success {
         background-color: #302d6f
      }
      ...
      .success-border {
         border-color: #302d6f !important;
      }

      /* Color !important */
      [data-text-color="success"] {
         color: #302d6f !important;
      }
      ...
      .single_add_to_cart_button.button {
         background-color: #302d6f !important
      }
      ...
      .header-main .current-dropdown .cart-icon strong,
      .header-main .header-button>.button:hover {
         background-color: #f79f8e !important;
      }

      .header-main .current-dropdown .cart-icon strong:after,
      .header-main .current-dropdown .cart-icon strong,
      .header-main .header-button>.button:hover {
         border-color: #f79f8e !important;
      }
...
<body data-rsssl=1 <?php $tongtien = 0; ?> class="home page-template page-template-page-blank page-template-page-blank-php page page-id-2 theme-flatsome woocommerce-no-js lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border mobile-submenu-slide mobile-submenu-slide-levels-1 mobile-submenu-toggle">
         ...
         <div class="header-wrapper">
                  ...
                  <div class="flex-col hide-for-medium flex-right">
                     <ul class="nav top-bar-nav nav-right nav-small  nav-divided">
                        ...
                        <?php if (isset($_SESSION['dangnhap'])) : ?>
                              ...
                              <li class="account-item has-icon has-dropdown">
                                 <a href="#" class="account-link account-login" title="Tài khoản">
                                    <span class="header-account-title">
                                       Xin chào <?php echo ($_SESSION['tenkhachhang']); ?> </span>
                                 </a>
                           ...
                           <?php elseif ($_SESSION['dangnhap'] == false) : ?>
            ...
            <div id="masthead" class="header-main ">
               <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                  ...
                  <div id="logo" class="flex-col logo">
                     <!-- Header logo -->
                     <a href="?mod=page&act=home" title="Mua theme - Theme Wordpress bán hoa tươi mẫu số 5" rel="home">
                        <img width="269" height="58" src="wp-content/uploads/2021/06/logo-shophoa.png" class="header_logo header-logo" alt="Mua theme" /><img width="269" height="58" src="wp-content/uploads/2021/06/logo-shophoa.png" class="header-logo-dark" alt="Mua theme" /></a>
                  </div>
            ...
            flex-grow">
                     <ul class="header-nav header-nav-main nav nav-left  nav-uppercase">
                        <li class="header-send-to"><span class=""><a href="he-thong-cua-hang/index.html"><i class="fas fa-map-marker-alt"></i>Hệ thống cửa hàng</a></span>
                        </li>
                        ...
                        <li class="cart-item has-icon">
                           <a href="gio-hang/index.html" class="header-cart-link off-canvas-toggle nav-top-link is-small" data-open="#cart-popup" data-class="off-canvas-cart" title="Giỏ hàng" data-pos="right">
                              ...
                              <span class="image-icon header-cart-icon" data-icon-label="0">
                                 <img class="cart-img-icon" alt="Giỏ hàng" src="wp-content/uploads/2021/05/shopping-cart.png" />
                              </span>
                           </a>
                                       ...
                                       <div class="widget_shopping_cart_content">
                                          <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                             ...
                                             <?php foreach ($showcart as $showcart) : ?>
                                                <?php
                                                $giaban = $showcart['giaban'] * $showcart['soluong'];
                                                $tongtien += $giaban;
                                                ?>
                                                <li class="woocommerce-mini-cart-item mini_cart_item">
                                                   <a href="?mod=cart&act=removecart&id_hoa=<?php echo $showcart['id_hoa'] ?>&id_khachhang=<?php echo $showcart['id_khachhang'] ?>" class="remove remove_from_cart_button" aria-label="Xóa sản phẩm này" data-product_id="368" data-cart_item_key="cf004fdc76fa1a4f25f62e0eb5261ca3" data-product_sku="">&times;</a> <a href="san-pham/pink-moon/index.html">
                                                      <img width="300" height="300" src="wp-content/uploads/2021/05/<?php echo $showcart['anhhoa'] ?>" data-src="wp-content/uploads/2021/05/<?php echo $showcart['anhhoa'] ?>" class="lazy-load attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" decoding="async" srcset="" data-srcset="wp-content/uploads/2021/05/<?php echo $showcart['anhhoa'] ?>" sizes="(max-width: 300px) 100vw, 300px" /><?php echo $showcart['tenhoa'] ?>
                                                   </a>
                                                   <span class="quantity"><?php echo $showcart['soluong'] ?> &times; <span class="woocommerce-Price-amount amount"><bdi><?php echo $showcart['tongtien'] ?><span class="woocommerce-Price-currencySymbol">.000
                                                               VND</span></bdi></span></span>
                                                </li>
                                             <?php endforeach; ?>
                                          </ul>
                                          <p class="woocommerce-mini-cart__total total">
                                             <strong>Tổng số phụ:</strong> <span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol"><?php echo $tongtien ?>.000
                                                      VND</span></bdi></span>
                                          </p>
                                    ...
                                    <div class="flex-row relative">
                                       ...
                                       <div class="flex-col flex-grow">
                                          <label class="screen-reader-text" for="woocommerce-product-search-field-1">Tìm
                                             kiếm:</label>
                                          <input type="search" id="woocommerce-product-search-field-1" class="search-field mb-0" placeholder="Tôi muốn tìm ..." value="" name="s" />
      ...
      <footer id="footer" class="footer-wrapper">
         ...
         <section class="section pb-0" id="section_1033527134">
            ...
            <div class="section-content relative">
               ...
               <div class="row" id="row-548520125">
                  ...
                  <div id="col-1190627604" class="col mh-col-footer medium-6 small-12 large-4 medium-col-first">
                     <div class="col-inner">
                        ...
                        <div id="text-2708258649" class="text justify">
                           <p>Chỉ từ 199k - Mua hoa tươi không lo về giá. Giao hàng miễn phí trong ngày, khu vực nội
                              thành Hà Nội, TpHCM. Thu tiền mặt tận nơi, chuyển khoản hoặc thanh toán qua thẻ. Lựa chọn
                              hoàn hảo cho những dịp đặc biệt: Sinh Nhật, Kỉ Niệm, Lãng Mạn, Ngày Phụ Nữ, Ngày
                              Valentine, Ngày của Mẹ. Ngoài ra, FlowerShop nhận đặt vòng hoa, kệ hoa khai trương, chúc
                              mừng và cho các dịp khác.</p>
                        </div>
                        <div id="gap-226598384" class="gap-element clearfix" style="display:block; height:auto;">
                           <style>
                              #gap-226598384 {
                                 padding-top: 10px;
                              }
                        ...
                        <div class="wpcf7 no-js" id="wpcf7-f141-o1" lang="en-US" dir="ltr">
                           ...
                           <form action="https://shophoa5.muathemewp.com/#wpcf7-f141-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                              ...
                              <div class="flex-row">
                                 <div class="flex-col flex-grow">
                                    <p><span class="wpcf7-form-control-wrap" data-name="your-email"><input size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email của tôi" value="" type="email" name="your-email" /></span>
                                    </p>
                                 </div>
                                 <div class="flex-col">
                                    <p><input class="wpcf7-form-control has-spinner wpcf7-submit button" type="submit" value="Theo dõi bản tin" />
                                    </p>
                                 </div>
                              </div>
                  ...
                  <div id="col-1752913161" class="col mh-col-footer medium-4 small-12 large-2">
                     <div class="col-inner">



                        <div id="text-899988540" class="text footer-title">
                  ...
                  <div id="col-1344970475" class="col mh-col-footer medium-4 small-12 large-2">
                     <div class="col-inner">
                        ...
                        <div class="ux-menu stack stack-col justify-start">
                           ...
                           <div class="ux-menu-link flex menu-item">
                              <a class="ux-menu-link__link flex" href="lien-he/index.html">
                                 <span class="ux-menu-link__text">
                           ...
                           <div class="ux-menu-link flex menu-item">
                              <a class="ux-menu-link__link flex" href="#">
                                 <span class="ux-menu-link__text">
                                    Các điều khoản chi tiết </span>
                              </a>
                           </div>


                           <div class="ux-menu-link flex menu-item">
                              <a class="ux-menu-link__link flex" href="https://giaohangtotnhat.vn/tra-cuu-van-don-best-express/">
                                 <span class="ux-menu-link__text">
                  ...
                  <div id="col-1242025645" class="col mh-col-footer medium-6 small-12 large-2 medium-col-first">
                     <div class="col-inner">



                        <div id="text-3244626708" class="text footer-title footer-contact">


                           <h5>Bạn có câu hỏi</h5>
                           <p>Thứ Hai - Chủ Nhật (9:00 - 18:00)</p>
                           <p><span>Hotline:</span> <a href="#">1900 63 xxxx</a></p>
                           <p><span>Facebook:</span> <a href="#">flowerstoreVN</a></p>
                           <p><span>Email:</span> <a href="#">contact@flowershop.vn</a></p>
                        </div>
                  ...
                  <div id="col-398303949" class="col mh-col-footer medium-4 small-12 large-2">
                     <div class="col-inner">
                        <div id="text-1261263191" class="text footer-title footer-global">


                           <h5>Flowerstore hiện có mặt tại</h5>
                           <p><a href="#">The Philippines</a></p>
               ...
               <div id="gap-777349663" class="gap-element clearfix" style="display:block; height:auto;">
         ...
         <section class="section pb-0" id="section_735525215">
            <div class="bg section-bg fill bg-fill  bg-loaded">
            ...
            <div class="section-content relative">
               ...
               <div class="row row-small align-bottom" id="row-1146069533">


                  <div id="col-1588075095" class="col mh-footer-bottom hide-for-medium medium-6 small-12 large-4">
                     <div class="col-inner">



                        <p>© 2023 <a href="https://trustweb.vn/">Trustweb.vn</a></p>
                  ...
                  <div id="col-1755648745" class="col mh-footer-bottom medium-12 small-12 large-4">
                     <div class="col-inner text-center">



                        <div id="text-4079975418" class="text show-for-medium">


                           <p>© 2023<a href="https://trustweb.vn/">Trustweb.vn</a></p>
                        </div>

                        <div class="social-icons follow-icons"><a href="#" target="_blank" rel="noopener noreferrer nofollow" data-label="Facebook" class="icon button circle is-outline facebook tooltip" title="Follow on Facebook" aria-label="Follow on Facebook"><i class="icon-facebook"></i></a><a href="#" target="_blank" rel="noopener noreferrer nofollow" data-label="Instagram" class="icon button circle is-outline instagram tooltip" title="Follow on Instagram" aria-label="Follow on Instagram"><i class="icon-instagram"></i></a><a href="#" data-label="Twitter" target="_blank" rel="noopener noreferrer nofollow" class="icon button circle is-outline twitter tooltip" title="Follow on Twitter" aria-label="Follow on Twitter"><i class="icon-twitter"></i></a><a href="#" data-label="Pinterest" target="_blank" rel="noopener noreferrer nofollow" class="icon button circle is-outline pinterest tooltip" title="Follow on Pinterest" aria-label="Follow on Pinterest"><i class="icon-pinterest"></i></a><a href="#" data-label="YouTube" target="_blank" rel="noopener noreferrer nofollow" class="icon button circle is-outline youtube tooltip" title="Follow on YouTube" aria-label="Follow on YouTube"><i class="icon-youtube"></i></a></div>
                  ...
                  <div id="col-2016019178" class="col mh-footer-bottom medium-12 small-12 large-4">
                     <div class="col-inner text-right">



                        <div class="payment-icons inline-block hide-for-medium">
   ...
   <div id="main-menu" class="mobile-sidebar no-scrollbar mfp-hide mobile-sidebar-slide mobile-sidebar-levels-1" data-levels="1">
      ...
      <div class="sidebar-menu no-scrollbar ">
         ...
         <ul class="nav nav-sidebar nav-vertical nav-uppercase nav-slide" data-tab="1">
            <li id="menu-item-602" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-602"><a href="#">Chủ đề</a>
               <ul class="sub-menu nav-sidebar-ul children">
                  <li id="menu-item-603" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-603"><a href="chu-de/hoa-dam-cuoi/index.html">Hoa đám cưới</a></li>
                  <li id="menu-item-611" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-611"><a href="chu-de/hoa-sinh-nhat/index.html">Hoa sinh nhật</a></li>
                  <li id="menu-item-605" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-605"><a href="chu-de/hoa-giang-sinh/index.html">Hoa giáng sinh</a></li>
                  <li id="menu-item-604" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-604"><a href="chu-de/hoa-dam-tang/index.html">Hoa đám tang</a></li>
                  <li id="menu-item-610" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-610"><a href="chu-de/hoa-ngay-nha-giao-viet-nam/index.html">Hoa ngày nhà giáo Việt Nam</a></li>
                  <li id="menu-item-609" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-609"><a href="chu-de/hoa-le-valentine/index.html">Hoa lễ Valentine</a></li>
                  <li id="menu-item-608" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-608"><a href="chu-de/hoa-le-8-3/index.html">Hoa lễ 8/3</a></li>
                  <li id="menu-item-606" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-606"><a href="chu-de/hoa-khai-truong/index.html">Hoa khai trương</a></li>
                  <li id="menu-item-607" class="menu-item menu-item-type-taxonomy menu-item-object-chu-de menu-item-607"><a href="chu-de/hoa-le-20-10/index.html">Hoa lễ 20/10</a></li>
               </ul>
            </li>
            <li id="menu-item-612" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-612"><a href="#">Thiết kế</a>
               <ul class="sub-menu nav-sidebar-ul children">
                  <li id="menu-item-614" class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-614"><a href="thiet-ke/bo-hoa/index.html">Bó hoa</a></li>
                  <li id="menu-item-615" class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-615"><a href="thiet-ke/gio-hoa/index.html">Giỏ hoa</a></li>
                  <li id="menu-item-618" class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-618"><a href="thiet-ke/lang-hoa/index.html">Lẵng hoa</a></li>
                  <li id="menu-item-613" class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-613"><a href="thiet-ke/binh-hoa/index.html">Bình hoa</a></li>
                  <li id="menu-item-616" class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-616"><a href="thiet-ke/hop-hoa/index.html">Hộp hoa</a></li>
                  <li id="menu-item-617" class="menu-item menu-item-type-taxonomy menu-item-object-thiet-ke menu-item-617"><a href="thiet-ke/ke-hoa/index.html">Kệ hoa</a></li>
               </ul>
            </li>
            <li id="menu-item-594" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-594">
               <a href="danh-muc/hoa-baby/index.html">Hoa baby</a>
            </li>
            <li id="menu-item-595" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-595">
               <a href="danh-muc/hoa-cam-chuong/index.html">Hoa cẩm chướng</a>
            </li>
            <li id="menu-item-596" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-596">
               <a href="danh-muc/hoa-cam-tu-cau/index.html">Hoa cẩm tú cầu</a>
            </li>
            <li id="menu-item-597" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-597">
               <a href="danh-muc/hoa-cuc/index.html">Hoa cúc</a>
            </li>
            ...
            <li id="menu-item-599" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-599">
               <a href="danh-muc/hoa-huong-duong/index.html">Hoa hướng dương</a>
            </li>
            <li id="menu-item-600" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-600">
               <a href="danh-muc/hoa-violet/index.html">Hoa Violet</a>
            </li>
            <li class="header-send-to"><span class=""><a href="he-thong-cua-hang/index.html"><i class="fas fa-map-marker-alt"></i>Hệ thống cửa hàng</a></span>
            </li>
         </ul>
   ...
   <div id="chat-scroll-section" class="chat-scroll-section is-show"><a class="open-chat-list-btn"> <i class="nki-chat-main-chatbox"></i> </a>
      <div class="select-chat-field">
         <div class="sticker-map"><a href="#" target="_blank" rel="noopener noreferrer"> <i class="nki-map-icon"></i>
               <span class="slide-tooltip">Xem bản đồ</span> </a></div>
         <div class="sticker-hotline-mobile2"><a href="tel:1900561242"> <i class="nki-call-chatbox"></i> <span class="slide-tooltip">Tổng đài: 1900.56.12.42</span> </a></div>
         ...
         <div class="sticker-zalo-chat"><a href="https://zalo.me/1900561242" target="_blank" rel="noopener noreferrer">
               <i class="nki-zalo-chatbox"></i> <span class="slide-tooltip">Chat Zalo</span> </a></div>
      </div>
   </div>
            ...
            <div class="col2-set row row-divided row-large" id="customer_login">
               <div class="col-1 large-6 col pb-0">
                  <div class="account-login-inner">
                     ...
                     <form class="woocommerce-form woocommerce-form-login login" method="post" action="?mod=user&act=login">
                  ...
                  <div class="account-register-inner">
                     ...
                     <form method="post" class="woocommerce-form woocommerce-form-register register" action="?mod=user&act=register">
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                           ...
                           <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="hoten" id="reg_email" autocomplete="hoten" value="" />
                        </p>
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        ...
                        <p>
                           ...
                           <input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="pass" id="reg_email" autocomplete="email" value="" />
                        </p>
                        <p>Với việc đăng kí bạn sẽ là thành viên chính thức của flowerShop</p>
                        <div class="woocommerce-privacy-policy-text"></div>
                        <p class="woocommerce-form-row form-row">
                           <input type="hidden" id="woocommerce-register-nonce" name="woocommerce-register-nonce" value="f6bfe6428e" /><input type="hidden" name="_wp_http_referer" value="/" /> <button type="submit" class="woocommerce-Button woocommerce-button button wp-element-button woocommerce-form-register__submit" name="register" value="Đăng ký">Đăng ký</button>
                        </p>
                     </form>
   ...
   <script type='text/javascript' id='contact-form-7-js-extra'>
      ...
      var wpcf7 = {
         "api": {
            "root": "https:\/\/shophoa5.muathemewp.com\/wp-json\/",
   ...
   <script type='text/javascript' id='wc-add-to-cart-js-extra'>
      ...
      var wc_add_to_cart_params = {
         ...
         "cart_url": "https:\/\/shophoa5.muathemewp.com\/gio-hang\/",
         "is_cart": "",
   ...
   <script type='text/javascript' id='wc-cart-fragments-js-extra'>
      ...
      var wc_cart_fragments_params = {
         "ajax_url": "\/wp-admin\/admin-ajax.php",
         "wc_ajax_url": "\/?wc-ajax=%%endpoint%%",
         "cart_hash_key": "wc_cart_hash_c6c4648d93370e61cdbd78ca29b9cad0",
         "fragment_name": "wc_fragments_c6c4648d93370e61cdbd78ca29b9cad0",
   ...
   <script type='text/javascript' id='flatsome-js-js-extra'>
      ...
      var flatsomeVars = {
         ...
         "ajaxurl": "https:\/\/shophoa5.muathemewp.com\/wp-admin\/admin-ajax.php",
         "rtl": "",
         "sticky_height": "70",
         "stickyHeaderHeight": "0",
         "scrollPaddingTop": "0",
         "assets_url": "https:\/\/shophoa5.muathemewp.com\/wp-content\/themes\/flatsome\/assets\/",
         "lightbox": {
   ...
   <script type='text/javascript' src='wp-content/themes/flatsome/inc/extensions/flatsome-lazy-load/flatsome-lazy-load.js' id='flatsome-lazy-js'>
   </script>
...
<![endif]-->
   <script type='text/javascript' src='wp-content/themes/flatsome-child/assets/js/custom.js' id='jss-custom-js'>
   </script>
   ...
   <script type='text/javascript' id='woof_front-js-before'>
      ...
      woof_current_page_link = "cua-hang/index.html";
      var woof_link = 'wp-content/plugins/woocommerce-products-filter/index.html';

      var woof_ajaxurl = "https://shophoa5.muathemewp.com/wp-admin/admin-ajax.php";
      ...
      var woof_accept_array = ["min_price", "orderby", "perpage", "min_rating", "chu-de", "thiet-ke", "product_visibility",
   ...
   <script type='text/javascript' src='wp-content/plugins/woocommerce-products-filter/js/front.js' id='woof_front-js'>
   </script>
   ...
   <script>
      jQuery("body").waypoint({
         handler: function() {
            jQuery("#chat-scroll-section").toggleClass("active")
         },
         offset: "-100%"
      });
