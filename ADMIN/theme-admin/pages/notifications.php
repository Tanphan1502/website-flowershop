...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="../model/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="../model/assets/img/favicon.png">
  <title>
    Admin_flowershop
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- Nucleo Icons -->
  <link href="../model/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="../model/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <!-- Material Icons -->maimai
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
  <!-- CSS Files -->
  <link id="pagestyle" href="../model/assets/css/material-dashboard.css?v=3.1.0" rel="stylesheet" />
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="../model/assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="../pages/category_admin.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="../pages/product_admin.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Thông báo</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Thông báo </h6>
        </nav>
  ...
  <!--   Core JS Files   -->
  <script src="../model/assets/js/core/popper.min.js"></script>
  <script src="../model/assets/js/core/bootstrap.min.js"></script>
  <script src="../model/assets/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="../model/assets/js/plugins/smooth-scrollbar.min.js"></script>
  <script>
  ...
  <script src="../model/assets/js/material-dashboard.min.js?v=3.1.0"></script>
</body>
